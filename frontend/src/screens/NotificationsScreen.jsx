          ...
          {displayNotifications.map((notification, index) => (
            ...
            >
              <div
                ...
                style={{
                  background: notification.type === 'success' ? 'rgba(73,250,132,0.15)' : notification.type === 'error' ? 'rgba(239,68,68,0.16)' : 'rgba(250,204,21,0.15)',
                  color: notification.type === 'success' ? '#49FA84' : notification.type === 'error' ? '#EF4444' : '#FACC15'
                }}
              >
                <i
                  className={`fas ${
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', marginBottom: '6px' }}>
                  ...
                  {!notification.read ? (
                    <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#49FA84', flexShrink: 0, marginTop: '6px' }}></span>
                  ) : null}
                </div>
                <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.58)', margin: '0 0 6px' }}>{notification.message}</p>
